...
namespace NetWork
{
    ...
    public class GetNoticeEventArgs : EventArgs
    {
        ...
        /// </summary>
        public Severs owner { get; private set; }

        /// <summary>
        /// 发送该消息的客户端，只有客户端类别中有值
        /// </summary>
        public Client clientOwner { get; private set; }

        /// <summary>
        /// 与该条提醒相关联的客户端，可能会未赋值
        /// </summary>
        public Severs.User relatedUser { get; private set; }

        /// <summary>
        /// 与该条提醒相关联的客户端，可能会未赋值
        /// </summary>
        public List<Severs.User> relatedUsers { get; private set; }
        ...
        public static GetNoticeEventArgs GetReceiveFromClient(Severs sender, Severs.User commucateUser, string msg)
        {
        ...
        public static GetNoticeEventArgs GetSendFailed(Severs sender, Severs.User commucateUser, string msg)
        {
        ...
        public static GetNoticeEventArgs GetSendFailed(Client sender, string msg)
        {
            GetNoticeEventArgs e = new GetNoticeEventArgs(sender, Attribute.SendFailed);
            e.commucateMessage = msg;
        ...
        ///     SeversSystem(注意这里包含很多):系统（服务端）的消息。
        /// 
        /// 客户端消息：
        ///     ClientSystem(注意这里包含很多):系统（客户端）的消息。
        ///     ReceiveFromSevers:服务端发来消息。
        ///     SendToSevers:向服务端发送信息
        ///     
        /// 通用:
        ...
        public enum Attribute
        {
            ...
            SendToClient, SendToClients, SendToAll, SeversSystem,
            //客户端消息
            ClientSystem, ReceiveFromSevers, SendToSevers, 
            //通用
